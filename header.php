				...
				<span class="site-title">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
						...
						<svg class="svg-logo" id="SVG-Circus-2fbebd4f-3289-1ff7-b576-77a6c417d914" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.79 51.32">
							...
							<polygon class="logo-black" points="20.34 49.77 0 2.28 21.95 2.28 38.17 42.26 35.99 49.77 20.34 49.77" />
							<path class="logo-yellow" d="M61.91,15.6c0,7.21-4.35,11.56-11.56,11.56S38.79,22.81,38.79,15.6,43.14,4,50.35,4c8,0,11.56,5.18,11.56,11.56" transform="translate(-6.9 -3.74)"/>
							<path id="actor_1" opacity="1" fill-opacity="1" class="logo-red" d="M61.91,15.6c0,7.21-4.35,11.56-11.56,11.56S38.79,22.81,38.79,15.6,43.14,4,50.35,4c8,0,11.56,5.18,11.56,11.56" transform="translate(-6.9 -3.74)"/>
							<rect class="logo-black" x="58.64" y="2.28" width="17.21" height="47.49"/>
							<path class="logo-black" d="M103.1,26.5c-10.5,0-15.26-6.28-15.37-20.34H105.9V26.5h-2.8Z" transform="translate(-6.9 -3.74)"/>
							<path class="logo-yellow" d="M87.73,53.72c0.11-14.06,4.86-20.34,15.37-20.34h2.8V53.72H87.73Z" transform="translate(-6.9 -3.74)"/>
							<path id="actor_2" opacity="1" fill-opacity="1" class="logo-red" d="M87.73,53.72c0.11-14.06,4.86-20.34,15.37-20.34h2.8V53.72H87.73Z" transform="translate(-6.9 -3.74)"/>
							<rect class="logo-black" x="105.46" y="2.28" width="16.84" height="47.49"/>
							<path class="logo-yellow" d="M140.44,27.73H134.2V6h6.23c9.1,0,14.41,3,14.28,11.9-0.13,7.57-5.28,9.82-14.28,9.82" transform="translate(-6.9 -3.74)"/>
							<path id="actor_3" opacity="1" fill-opacity="1" class="logo-red" d="M140.44,27.73H134.2V6h6.23c9.1,0,14.41,3,14.28,11.9-0.13,7.57-5.28,9.82-14.28,9.82" transform="translate(-6.9 -3.74)"/>
							<path class="logo-black" d="M152.25,54.12c-11.48,0-17.55-6-17.55-17.29V32.11H141c5.55,0,9.48,1.25,12,3.83s3.76,6.59,3.68,12.24l-0.1,5.95h-4.32Z" transform="translate(-6.9 -3.74)"/>
							<path class="logo-black" d="M190.28,53.51l-0.1-17.25h-0.25l0.2-.49L175.6,6H155.12L173.52,42V53.51h16.76Z" transform="translate(-6.9 -3.74)"/>
							<path class="logo-yellow" d="M208.75,14.92c0,7-4.2,11.18-11.18,11.18s-11.18-4.21-11.18-11.18,4.2-11.18,11.18-11.18,11.18,4.21,11.18,11.18" transform="translate(-6.9 -3.74)"/>
							<path id="actor_4" opacity="1" fill-opacity="1" class="logo-red" d="M208.75,14.92c0,7-4.2,11.18-11.18,11.18s-11.18-4.21-11.18-11.18,4.2-11.18,11.18-11.18,11.18,4.21,11.18,11.18" transform="translate(-6.9 -3.74)"/>
